from __future__ import absolute_import#绝对引入 引入系统的包
...
class SaConvLSTM2DCell(DropoutRNNCellMixin, Layer):
    ...
    def __init__(self,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        super(SaConvLSTM2DCell, self).__init__(**kwargs)#继承父类属性
    ...
    def call(self, inputs, states, training=None):
        ...
        e_m = tf.matmul(k_m, K.permute_dimensions(q_h, [0, 2, 1]))
        alpha_m = K.softmax(e_m)
        e_h = tf.matmul(k_h, K.permute_dimensions(q_h, [0, 2, 1]))
